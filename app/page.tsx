      ...
      <section id="servicos" className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link href="/transformacao-processos" className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow group">
              <div className="h-48 flex items-center justify-center mb-6">
                <svg className="w-20 h-20 text-[#3498db]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
              </div>
              <h3 className="text-2xl font-heading font-bold text-dark mb-3 group-hover:text-[#3498db] transition-colors">
              ...
              <span className="text-[#3498db] font-semibold group-hover:underline">Saiba Mais →</span>
            </Link>

            <Link href="/arquitetura-solucoes-ia" className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow group">
              <div className="h-48 flex items-center justify-center mb-6">
                <svg className="w-20 h-20 text-[#3498db]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/pmo-as-service" className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-shadow group">
              <div className="h-48 flex items-center justify-center mb-6">
                <svg className="w-20 h-20 text-[#3498db]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
